CREATE DATABASE ferreteriafrsc;
...
CREATE USER 'ferreteriafrsc'@'localhost' IDENTIFIED BY 'ferreteriafrsc.2019';
GRANT ALL PRIVILEGES ON ferreteriafrsc.* TO 'ferreteriafrsc'@'localhost';
FLUSH PRIVILEGES;
